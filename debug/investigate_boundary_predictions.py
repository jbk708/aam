...
def main():
    ...
    parser.add_argument(
        "--embedding-dim", type=int, default=None, help="Embedding dimension (will be inferred from checkpoint if not provided)"
    )
    ...
    parser.add_argument(
        ...
        type=int,
        default=None,
        help="Number of attention layers (will be inferred from checkpoint if not provided)",
    )
