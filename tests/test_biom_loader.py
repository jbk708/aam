...
def low_depth_table():
    ...
    observation_ids = [
        generate_150bp_sequence(seed=20),
        generate_150bp_sequence(seed=21),
        generate_150bp_sequence(seed=22)
    ]
...
def very_low_depth_table():
    ...
    observation_ids = [
        generate_150bp_sequence(seed=30),
        generate_150bp_sequence(seed=31),
        generate_150bp_sequence(seed=32)
    ]
...
def empty_table():
    ...
    observation_ids = [
        generate_150bp_sequence(seed=40),
        generate_150bp_sequence(seed=41)
    ]
...
class TestBIOMLoader:
    ...
    def test_rarefy_reproducibility(self, loader, simple_table):
        ...
        np.testing.assert_array_equal(
            rarefied1.matrix_data.toarray(),
            rarefied2.matrix_data.toarray()
        )
    ...
    def test_get_sequences_from_ids(self, loader):
        ...
        observation_ids = [
            generate_150bp_sequence(seed=50),
            generate_150bp_sequence(seed=51)
        ]
        sample_ids = ['sample1', 'sample2']
        table = Table(
            data,
    ...
    def test_get_sequences_no_metadata_needed(self, loader):
        ...
        data = np.array([[10, 20], [15, 10]])
        observation_ids = [
            generate_150bp_sequence(seed=60),
            generate_150bp_sequence(seed=61)
        ]
        sample_ids = ['sample1', 'sample2']
        table = Table(
            data,
    ...
    def test_get_sequences_150bp(self, loader):
        ...
        data = np.array([[10, 20], [15, 10]])
        observation_ids = [
            generate_150bp_sequence(seed=70),
            generate_150bp_sequence(seed=71)
        ]
        sample_ids = ['sample1', 'sample2']
        table = Table(
            data,
    ...
    def test_get_sequences_always_works(self, loader):
        ...
        data = np.array([[10], [15]])
        observation_ids = [
            generate_150bp_sequence(seed=80),
            generate_150bp_sequence(seed=81)
        ]
        sample_ids = ['sample1']
        table = Table(
            data,
